...
CLEANUP_DIRS=(/etc/ceph /etc/cni /etc/kubernetes /opt/cni /opt/rke /run/secrets/
kubernetes.io /run/calico /run/flannel /var/lib/calico /var/lib/weave /var/lib/e
tcd /var/lib/cni /var/lib/kubelet/* /var/lib/rancher/rke/log /var/log/containers
...
help() {
  ...
  !! Warning, this script removes containers and all data specific to Kubernetes
 and Rancher
